# Protosuit Engine MQTT API Reference

All inter-service communication in the Protosuit Engine uses MQTT via the local Mosquitto broker. This document covers every MQTT topic published or subscribed to across all services.
